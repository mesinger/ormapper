...
interface PersistenceManagerUtils {
     ...
     */
    static PersistentStructure getPersistentStructureOf(Object o, Class cls) {
        ...
        try {
            ...
            for(Field field : cls.getDeclaredFields()) {
                ...
                if(!isForeign) {
                    ...
                    entries.add(new PersistentField(field.getName(), Optional.ofNullable(value), isNullable, isPrimary, isForeign, getPersistenceObjectsTableName(field.getClass()), "id"));
                }
            }
